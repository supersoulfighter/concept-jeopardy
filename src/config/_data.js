...
Syntax
Data, aka literals
Data types, data structures, databases
...
#Game Design
Mechanics, conventions and conceits: e.g., powerups, leveling, portals, lives
Pacing: flow, grind, levels, cutscenes, bosses, quests
Microtransactions
Mini games & puzzles
Balance and economy
Writing
...
Characters
Dialogue
Genre: e.g., rpg, horror, Ex4, rogue
Lore

#UI/UX Design
Human factors
Cognitive load, expert vs beginner, recall vs recognition
UI vs content
Layout, hierarchy, typography, color,
Flow and usability, onboarding, tutorials
...
Patterns
Hierarchy
Depth: size, imposition, parallax, shading, brightness, saturation, perspective, figurative mapping
Light & shade
Anatomy & proportion
Composition
Rendering
...
Medium
Style / genre
Concept/cutscene vs texture vs UI vs VFX
3D vs 2D
Vector vs raster
Animation: keyframes
Animation: rigging
...
The sound wave. Length and height Wavelength: The physical distance required for a sound wave to complete one full compression/rarefaction cycle, inversely proportional to its frequency. Amplitude & Loudness: The height of a sound wave's displacement, determining its physical strength and perceived volume (measured in decibels, dB).
Tempo (BPM) & Key Signatures: Using tempo adjustments and major/minor key selection to directly manipulate player heartbeat, tension, and emotional tone.
Texture & Timbre: Selecting the specific sound "color" or instrument quality (e.g., warm cello vs. distorted bit-crushed synth) to reinforce visual aesthetic.
Environment: Resonance: The natural tendency of objects, enclosures, or acoustic spaces to vibrate more intensely and amplify specific fundamental frequencies. Doppler Effect: The change in perceived frequency or pitch resulting from relative movement between the sound source and the observer. Noise. Phase canceling

#Composition
Leitmotif & Thematic Identity: Assigning recurring musical themes or distinct instrument choices to specific characters, locations, or factions.
Seamless Looping: Designing tracks to repeat infinitely without noticeable start/end boundaries or jarring volume cuts.
Adaptive / Interactive Music: Constructing scores that dynamically change in real time based on player behavior, location, or combat intensity.
Loop Endurance & Anti-Fatigue Design: Crafting melodies, harmonic loops, and structural arrangements that remain pleasant across dozens of hours of repetitive gameplay without becoming grating or causing cognitive fatigue.
Stingers & Transition Bridges: Composing short, high-impact musical phrases that bridge abrupt gameplay state changes (e.g., sudden combat triggers) or punctuate key moments (level completions, item discoveries) without interrupting the musical key or tempo.
Motivic Development & Palette Variation: Re-harmonizing and re-instrumenting a central character or location theme across different keys, tempos, and genres to mirror narrative progression or environmental biome shifts.

#Sound Design
Reading a sound wave
Mixing
ADSR Envelope (Attack, Decay, Sustain, Release): The four distinct stages describing how a sound's volume and energy evolve over time from trigger to silence.
Spatialization & Origin: Utilizing 3D panning, attenuation curves, and distance filtering to inform players exactly where a sound is located spatially. And UI
Foley & Sound Synthesis: Creating custom sound effects using real-world physical objects (Foley) or digital synthesizers rather than relying entirely on stock libraries.
Cleaning: Frequency Carving (EQ): Trimming overlapping frequencies across tracks so instruments and sound effects don't clash or sound "muddy" when played simultaneously. Dynamic Range & Normalization and cleaning: Balancing soft ambient moments against loud action peaks to ensure clear mix levels without clipping or distortion.
Gameplay: user feedback, setting, states
...
#Product Management
Metrics: DAU, MAU, Retention, Churn, Revenue
...
#Sales
Prospecting: research and networking
Pitching: listening, charm, value-based, objections
Hustle: follow up
Pipeline, funnel: awareness, consideration, intent, conversion, retention, advocacy

#QA
Internal testing
Reports: steps to reproduce, categorization, system specs, recommendation
Automation & unit tests
External testing: Usability lab, focus groups, and multivariate testing
Support
...
Modularity: functions, classes, packages, frameworks, APIs
Git
Debugging
Algorithms
Recursion
